...
var dequeLinkedList: DequeLinkedList<Int> = DequeLinkedList<Int>()
dequeLinkedList.enqueue(1, to: .back)
dequeLinkedList.enqueue(2, to: .back)
dequeLinkedList.enqueue(3, to: .back)
dequeLinkedList.enqueue(4, to: .back)
dequeLinkedList.enqueue(0, to: .front)
print(dequeLinkedList)
print(dequeLinkedList.peek(from: .front)!)
print(dequeLinkedList.peek(from: .back)!)
dequeLinkedList.dequeue(from: .front)
print(dequeLinkedList)
dequeLinkedList.dequeue(from: .back)
print(dequeLinkedList)
dequeLinkedList.dequeue(from: .front)
print(dequeLinkedList)
dequeLinkedList.dequeue(from: .back)
